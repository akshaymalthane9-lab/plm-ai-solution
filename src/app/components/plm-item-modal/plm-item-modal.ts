...
@Component({
        ...
        <div class="modal-body">
          ...
          <ng-container *ngIf="activeTab === 'WhereUsed'">
            <div class="empty-state card">
               No parent assemblies currently reference this item.
            </div>
          </ng-container>
  ...
  styles: `
    ...
    .overview-panel { position: relative; padding-top: 1rem; }
    .overview-edit { position: absolute; top: 0; right: 0; padding: 0.55rem 1rem; border-radius: 4px; background: var(--text-secondary); color: #fff; border: 0; font-size: 0.75rem; text-transform: uppercase; }
    .overview-grid { display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 0.9fr); column-gap: 4rem; row-gap: 1.35rem; padding: 1.75rem 5rem 1rem 0; }
    .overview-field { display: grid; grid-template-columns: 145px minmax(0, 1fr); align-items: start; gap: 1.25rem; color: var(--text-primary); }
    .overview-field:nth-child(2n) { grid-template-columns: 165px minmax(0, 1fr); }
    .field-label { font-weight: 700; color: var(--text-secondary); line-height: 1.4; }
    .field-value { color: var(--text-primary); line-height: 1.4; }
    .link-value { color: var(--accent-primary-hover); font-weight: 700; }
    .description-field { grid-row: span 2; align-items: start; }
    ...
    .character-count { grid-column: 2; margin-top: -0.9rem; font-size: 0.75rem; color: var(--text-muted); }
    .bom-divider { height: 2px; background: var(--text-primary); opacity: 0.8; margin: 1.5rem 0 1.25rem; }
    ...
    .bom-table-container { border-radius: 0; box-shadow: none; }
    .bom-table-container .data-table th { color: var(--text-primary); font-size: 0.82rem; text-transform: none; border-bottom: 2px solid var(--border-color); }
    .bom-table-container .data-table td { color: var(--text-secondary); }
    .bom-child-indent { display: inline-block; padding-left: 1.5rem; position: relative; }
    .bom-child-indent::before { content: '└─'; position: absolute; left: 0; color: var(--text-muted); }
    ...
    @media (max-width: 840px) {
      .overview-grid { grid-template-columns: 1fr; padding-right: 0; }
      .overview-field, .overview-field:nth-child(2n) { grid-template-columns: 1fr; gap: 0.3rem; }
      .character-count { grid-column: 1; margin-top: -0.6rem; }
